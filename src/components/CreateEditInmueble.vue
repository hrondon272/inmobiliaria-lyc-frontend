<template>
  <div
    class="formgrid grid w-12 md:w-10 mx-auto p-3 md:p-4 text-white"
  ...
  >
    ...
    <div class="field col-6 md:col-2 mt-2">
      <FloatLabel>
        <InputNumber
          v-model="form.cantidadDormitorios"
          :class="{ 'p-invalid': v$.cantidadDormitorios.$error }"
          showButtons
          :min="0"
          fluid
        />
    ...
    <div class="field col-6 md:col-2 mt-2">
      <FloatLabel>
        <InputNumber
          :min="0"
          v-model="form.cantidadBanos"
          :class="{ 'p-invalid': v$.cantidadBanos.$error }"
          showButtons
          fluid
        />
        <label># baños</label>
    ...
    <div class="field col-12 md:col-4 mt-2">
      <FloatLabel>
        <SelectPrime
          ...
          :class="{ 'p-invalid': v$.idTipo.$error }"
          fluid
        />
    ...
    <div class="field col-6 md:col-3 mt-2">
      <FloatLabel>
        <SelectPrime
          v-model="form.idCiudad"
          :options="companyData?.ciudades"
          optionLabel="descripcion"
          optionValue="id"
          placeholder="Ciudad"
          class="w-full md:w-56"
          :class="{ 'p-invalid': v$.idCiudad.$error }"
          fluid
        />
        <label>Ciudad</label>
      </FloatLabel>
    ...
    <div class="field col-12 md:col-6 mt-2">
      <FloatLabel variant="in">
        <TextareaPrime
          ...
          rows="4"
          :class="{ 'p-invalid': v$.caracteristicas.$error }"
          fluid
        />
    ...
    <div class="field col-6 md:col-3 mt-2">
      <FloatLabel variant="on">
        <InputNumber
          ...
          :minFractionDigits="0"
          :maxFractionDigits="0"
          :class="{ 'p-invalid': v$.precio.$error }"
          fluid
        />
    ...
    <div class="field col-6 md:col-3 mt-2">
      <div class="flex items-center">
        <SelectPrime
          ...
          :options="alquilerVentaOptions"
          optionLabel="name"
          optionValue="value"
          placeholder="Seleccione una opción"
          class="w-full md:w-56"
          :class="{ 'p-invalid': v$.tipoOperacion.$error }"
        />
      </div>
      <div class="p-error" v-for="error of v$.tipoOperacion.$errors" :key="error.$uid">
        <div class="error-msg">{{ error.$message }}</div>
      </div>
    </div>
    ...
    <file-upload
      v-if="!isEditing"
      @update:listaFotos="actualizarListaFotos"
      ref="fileSelector"
    ...
    <div class="col-12 text-center mt-4">
      <ButtonPrime
        icon="pi pi-save"
        :aria-label="isEditing ? 'Actualizar información' : 'Registrar inmueble'"
        :label="isEditing ? 'Actualizar información' : 'Registrar inmueble'"
        @click="onSubmit"
      />
    </div>
    <DialogPrime
      ...
      modal
      header="Seleccione la ubicación del inmueble."
      :style="{ width: '90%' }"
    >
      <location-selector
...
const alquilerVentaOptions = ref([
